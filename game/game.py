...
background1 = pygame.transform.smoothscale(pygame.image.load("game assets/background 1.png").convert_alpha(),(window_width, window_height))

parked_bic1 = pygame.transform.smoothscale(pygame.image.load("game assets/anywheel parked bicycles.png").convert_alpha(),(parked_bic_game1_width, parked_bic_game1_height))
mask_parked_bic1 = pygame.mask.from_surface(parked_bic1)
parked_bic1_rect = parked_bic1.get_rect(center=(105, 395))

parked_bic2 = pygame.transform.smoothscale(pygame.image.load("game assets/anywheel parked bicycles.png").convert_alpha(),(parked_bic_game1_width, parked_bic_game1_height))
mask_parked_bic2 = pygame.mask.from_surface(parked_bic2)
parked_bic2_rect = parked_bic2.get_rect(center=(105, 450))

parked_bic3 = pygame.transform.smoothscale(pygame.image.load("game assets/anywheel parked bicycles.png").convert_alpha(),(parked_bic_game1_width, parked_bic_game1_height))
mask_parked_bic3 = pygame.mask.from_surface(parked_bic3)
parked_bic3_rect = parked_bic3.get_rect(center=(105, 505))

parked_bic4 = pygame.transform.smoothscale(pygame.image.load("game assets/anywheel parked bicycles.png").convert_alpha(),(parked_bic_game1_width, parked_bic_game1_height))
mask_parked_bic4 = pygame.mask.from_surface(parked_bic4)
parked_bic4_rect = parked_bic4.get_rect(center=(105, 560))

bic_sprite = pygame.transform.smoothscale(pygame.image.load("game assets/anywheel sprite.png").convert_alpha(),(bic_sprite_width, bic_sprite_height))
...
cross_button = pygame.transform.smoothscale(pygame.image.load("game assets/cross button.png").convert_alpha(),(cross_button_width, cross_button_height))
cross_button_rect = cross_button.get_rect(center = (330, 60))
cross_button_area = pygame.Rect(306, 20, 66, 63)

border = pygame.transform.smoothscale(pygame.image.load("game assets/blue border.png").convert_alpha(),(border_width, border_height))
border_rect = border.get_rect()
border_rect.center = (105,330)

cw_rotate_button = pygame.transform.smoothscale(pygame.image.load("game assets/white rotate button.png").convert_alpha(),(rotate_button_width, rotate_button_height))
cw_rotate_button_rect = cw_rotate_button.get_rect(center = (308,767))
cw_rotate_button_area = pygame.Rect(268, 690, 100, 100)

acw_rotate_button = pygame.transform.smoothscale(pygame.image.load("game assets/white rotate button.png").convert_alpha(),(rotate_button_width, rotate_button_height))
acw_rotate_button_rect = acw_rotate_button.get_rect(center = (59,767))
acw_rotate_button_area = pygame.Rect(22, 690, 100, 100)

acw = pygame.transform.smoothscale(pygame.image.load("game assets/acw.png").convert_alpha(), (arrow_width, arrow_height))
acw_rect = acw.get_rect(center=(70, 740))

cw = pygame.transform.smoothscale(pygame.image.load("game assets/cw.png").convert_alpha(), (arrow_width, arrow_height))
cw_rect = cw.get_rect(center=(320, 740))

destination_text = font.render("DESTINATION", 1, "#2bceff")

instructions1 = pygame.transform.smoothscale(pygame.image.load("game assets/instructions1.png").convert_alpha(),(instruction_width, instruction_height))
instructions1_rect = instructions1.get_rect(center = (195, 160))

transition_text = pygame.transform.smoothscale(pygame.image.load("game assets/transition text.png").convert_alpha(),(transition_text_width, transition_text_height))
transition_text_rect = transition_text.get_rect(center = (182, 500))

winning_area = pygame.Rect(97, 275, 25, 75)

start_text = pygame.transform.smoothscale(pygame.image.load("game assets/start.png").convert_alpha(),(start_text_width, start_text_height))
start_text_rect = start_text.get_rect(center = (185, 700))
start_text_area = pygame.Rect(80, 560, 224, 150)

next_text = pygame.transform.smoothscale(pygame.image.load("game assets/next.png").convert_alpha(),(next_text_width, next_text_height))
next_text_rect = next_text.get_rect(center = (195, 700))
next_text_area = pygame.Rect(90, 560, 224, 150)

background2 = pygame.transform.smoothscale(pygame.image.load("game assets/game 2 background.png").convert_alpha(),(window_width, window_height))

parked_bic5 = pygame.transform.smoothscale(pygame.image.load("game assets/parked bic game 2.png").convert_alpha(),(parked_bic_game2_width, parked_bic_game2_height))
parked_bic5_rect = parked_bic5.get_rect(center = (0, 505))

parked_bic6 = pygame.transform.smoothscale(pygame.image.load("game assets/parked bic game 2.png").convert_alpha(),(parked_bic_game2_width, parked_bic_game2_height))
parked_bic6_rect = parked_bic6.get_rect(center = (390, 505))

bic_body = pygame.transform.smoothscale(pygame.image.load("game assets/bic body game 2.png").convert_alpha(),(bic_body_width, bic_body_height))
bic_body_rect = bic_body.get_rect(center = (160, 497))

original_handlebar = pygame.transform.smoothscale(pygame.image.load("game assets/handlebar.png").convert_alpha(),(handlebar_width, handlebar_height))
...
handlebar_target_position = pygame.transform.smoothscale(pygame.image.load("game assets/target position.png").convert_alpha(),(handlebar_target_width, handlebar_target_height))
...
cw_tilt_icon = pygame.transform.smoothscale(pygame.image.load("game assets/cw tilt icon.png").convert_alpha(),(tilt_icon_width, tilt_icon_height))
cw_tilt_icon_rect = cw_tilt_icon.get_rect(center = (321,741))
cw_tilt_icon_area = pygame.Rect(270, 688, 100, 100)

acw_tilt_icon = pygame.transform.smoothscale(pygame.image.load("game assets/acw tilt icon.png").convert_alpha(),(tilt_icon_width, tilt_icon_height))
acw_tilt_icon_rect = acw_tilt_icon.get_rect(center = (70,741))
acw_tilt_icon_area = pygame.Rect(20, 688, 100, 100)

instructions2 = pygame.transform.smoothscale(pygame.image.load("game assets/instructions2.png").convert_alpha(),(495, 270))
instructions2_rect = instructions2.get_rect(center = (217, 180))

npc = pygame.transform.smoothscale(pygame.image.load("game assets/npc.png").convert_alpha(),(npc_width, npc_height))
npc_rect = npc.get_rect(center = (510, 490))

accuracy_text = pygame.transform.smoothscale(pygame.image.load("game assets/accuracy text.png").convert_alpha(),(325, 703))
accuracy_text_rect = accuracy_text.get_rect(center = (195, 620))

parking_symbol = pygame.transform.smoothscale(pygame.image.load("game assets/parking symbol.png").convert_alpha(),(170, 170))
parking_symbol_rect = parking_symbol.get_rect(center = (195, 580))
parking_symbol_area = pygame.Rect(110, 500, 170, 170)

well_done_text = pygame.transform.smoothscale(pygame.image.load("game assets/well done.png").convert_alpha(),(550, 248))
well_done_rect = well_done_text.get_rect(center = (195, 200))

hmm_text = pygame.transform.smoothscale(pygame.image.load("game assets/hmmm text.png").convert_alpha(),(715, 323))
hmm_text_rect = hmm_text.get_rect(center = (205, 200))

retry = pygame.transform.smoothscale(pygame.image.load("game assets/retry.png").convert_alpha(),(200,433))
retry_rect = retry.get_rect(center = (187, 780))
retry_area = pygame.Rect(110, 675, 170, 115)

exit_text = pygame.transform.smoothscale(pygame.image.load("game assets/exit.png").convert_alpha(),(200,433))
