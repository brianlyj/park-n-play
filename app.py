                ...
                for event in pygame.event.get():
                    if event.type == pygame.MOUSEBUTTONDOWN:
                        ...
                        if cross_button_area.collidepoint(touch_pos):
                            ...
                            # Reset all assets and restart game1
                            reset_game_assets()
...
def reset_game_assets():
    global bic_sprite_angle, rotated_bic_sprite, rotated_bic_sprite_rect, mask_rotated_bic_sprite
    global handlebar_angle, handlebar, handlebar_rect
    global npc_left_x, npc_left_y, npc_right_x, npc_right_y, left_forearm_height, right_forearm_height
    global game1_start, game1_active, transition, game2_start, game2_active, time_inside_area

    # Reset bicycle sprite
    bic_sprite_angle = 0
    rotated_bic_sprite = pygame.transform.rotate(bic_sprite, bic_sprite_angle)
    rotated_bic_sprite_rect = rotated_bic_sprite.get_rect(center=(263, 620))
    mask_rotated_bic_sprite = pygame.mask.from_surface(rotated_bic_sprite)
